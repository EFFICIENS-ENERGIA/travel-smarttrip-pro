...
print("=" * 70)
print("BANC D'ESSAI AUTOMATISÉ : CIBLAGE HOTEL NEW YORK & GARDE-FOU GÉODÉSIQUE")
print("=" * 70)
...
test_file = os.path.abspath("scratch/test_hotel_new_york_suite.html")
test_url = "file:///" + test_file.replace("\\", "/")
screenshot_path = r"C:\Users\EFFICIENS ENERGIA\.gemini\antigravity\brain\f076e0be-08ee-48cc-9303-5a3edb1e0506\test_hotel_new_york_suite_screenshot.png"
