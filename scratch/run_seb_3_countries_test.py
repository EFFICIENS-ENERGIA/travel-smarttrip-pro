...
print("=" * 70)
print("BANC D'ESSAI AUTOMATISÉ : VALIDATION SPÉCIFIQUE SEB (ROME, BARCELONE, MIAMI)")
print("=" * 70)
...
test_file = os.path.abspath("scratch/test_seb_3_countries_suite.html")
test_url = "file:///" + test_file.replace("\\", "/")
screenshot_path = r"C:\Users\EFFICIENS ENERGIA\.gemini\antigravity\brain\f076e0be-08ee-48cc-9303-5a3edb1e0506\test_seb_3_countries_suite_screenshot.png"
...
if all_pass and len(test_boxes) >= 8:
